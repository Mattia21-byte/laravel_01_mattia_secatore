...
<div class="container-fluid">
    ...
    <h2 class="display-4 text-center p-4 fw-bold text-dark">Pagina 2</h2>
    
    <p class="lead text-center">In questa pagina trovi informazioni sulla Pagina 2.</p>

    <img src="https://picsum.photos/400/600" class="img-fluid rounded mx-auto d-block" alt="Immagine casuale"/>
